...
{
    /// <inheritdoc />
    public partial class Cand : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    candImagePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    LMPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Candidates", x => x.idCand);
                });
        }
